  ...
  const base = [
    {
      ...
      module_weight: 0.25,
      budget_inr: (manualBudgets?.frontend && manualBudgets.frontend > 0) ? manualBudgets.frontend : Math.round(totalPrice * 0.25),
    ...
    },
    {
      ...
      module_type: 'backend',
      module_weight: 0.35,
      budget_inr: (manualBudgets?.backend && manualBudgets.backend > 0) ? manualBudgets.backend : Math.round(totalPrice * 0.35),
    ...
    },
    {
      ...
      module_weight: 0.25,
      budget_inr: (manualBudgets?.database && manualBudgets.database > 0) ? manualBudgets.database : Math.round(totalPrice * 0.25),
    ...
    },
    {
      ...
      module_weight: 0.15,
      budget_inr: (manualBudgets?.infrastructure && manualBudgets.infrastructure > 0) ? manualBudgets.infrastructure : Math.round(totalPrice * 0.15),
